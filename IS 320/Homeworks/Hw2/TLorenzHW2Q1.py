...
input: lbs_art: float, lbs_carrots: float, lbs_beets: float
output:preship_order_price: float, ship_cost: float, billed_amount: float
"""
...
if total_weight <= 10.0:
    ...
    ship_cost = 9.50 + total_weight * 0.10
